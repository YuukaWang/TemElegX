...
\usepackage{enumitem}
\usepackage{tabu, multirow, colortbl, makecell, lscape, booktabs} %table
%\usepackage{chemfig} %chemical formula
...
\setCJKmainfont{思源宋体 Light}[BoldFont=思源宋体 SemiBold, ItalicFont=FZKai-Z03]
...
\newCJKfontfamily\fangs{FZFangSong-Z02} % 仿宋  建议不用于PDF中
\newCJKfontfamily\shus{FZShuSong-Z01} % 书宋    因为方正此四字体嵌入后
\newCJKfontfamily\kai{FZKai-Z03} % 楷体         商业使用需要得到方正授权
